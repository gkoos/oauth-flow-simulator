...
function requireLogin(req, res, next) {
  ...
  // Remove delay from query before redirecting to login
...
app.get('/authorize', delayMiddleware, validateAuthorizeRequest, requireLogin, (req, res) => handleAuthorize(req, res, {
  isValidRedirectUri,
  authCodes,
  clients
}));
app.post('/token', delayMiddleware, (req, res) => handleToken(req, res, {
...
app.post('/revoke', delayMiddleware, (req, res) => handleRevoke(req, res, {
  getClient: (id) => getClient(clients, id),
  tokens,
  refreshTokens
}));
app.post('/introspect', delayMiddleware, (req, res) => handleIntrospect(req, res, {
  getClient: (id) => getClient(clients, id),
  tokens,
  refreshTokens
}));
