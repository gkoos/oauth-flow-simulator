...
app.get('/authorize', validateAuthorizeRequest, requireLogin, (req, res) => handleAuthorize(req, res, {
  isValidRedirectUri,
  authCodes,
  clients
}));
app.post('/token', (req, res) => handleToken(req, res, {
...
app.post('/revoke', (req, res) => handleRevoke(req, res, {
  getClient: (id) => getClient(clients, id),
  tokens,
  refreshTokens
}));
app.post('/introspect', (req, res) => handleIntrospect(req, res, {
  getClient: (id) => getClient(clients, id),
  tokens,
  refreshTokens
}));
